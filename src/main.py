...
import src.filter_warnings  # noqa: F401 # pylint: disable=unused-import
from src.misc.nice_exit import nice_exit
...
def _setup_logger(verbose):
    ...
    from src.utils.custom_logging import CH, DEBUG, INFO
    if verbose:
        CH.setLevel(DEBUG)
    else:
        CH.setLevel(INFO)
...
def _another_instance_is_running():
    ...
    # noinspection PyUnresolvedReferences
    from src.ui import qt_resource  # noqa: F401  # pylint: disable=unused-variable
...
def main(test, profile, verbose):  # pylint: disable=too-many-locals
    ...
    try:
        ...
        try:
            ...
            from src.global_ import QT_APP
