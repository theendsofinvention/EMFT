...
from src.misc import downloader, nice_exit
from src.utils import ThreadPool, make_logger
from src.utils import WatchedProperty
from src.utils.av import AVSession, AVBuild  # noqa: F401
from src.utils.updater.channel import Channel
from src.utils.updater.customspec import CustomSpec
from src.utils.updater.customversion import CustomVersion
...
class Updater(Machine):
    def __init__(self, current_version: str, av_user: str, av_repo: str, local_executable: str, channel: str):
        Machine.__init__(
            self,
            states=[
                'initial',
    ...
    def find_latest_version_on_channel(self, channel: Channel):
