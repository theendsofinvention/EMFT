...
from emft.core.filesystem.dcs_skin import DCSSkin
from emft.core.filesystem.saved_games import saved_games_path
...
class DCSInstalls:
    def __init__(self):
        ...
        self.installs_props = {
            'stable': {
                'reg_key': constant.DCS['reg_key']['stable'],
                'sg_default': 'DCS',
                'install': None,
                'sg': None,
                'version': None,
            ...
            'beta': {
                'reg_key': constant.DCS['reg_key']['beta'],
            ...
            'alpha': {
                'reg_key': constant.DCS['reg_key']['alpha'],
